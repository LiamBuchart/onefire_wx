const __pluginConfig =  {
  ...
  "built": 1753219434931,
  "builtReadable": "2025-07-22T21:23:54.931Z"
};
...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			small0.innerHTML = `This is just example for our plugin developers,
        so <b>airspace data are obsolete</b> and not updated ☠️`;

			t3 = space();
			small1 = element("small");
			small1.innerHTML = `Airspaces provided by <a href="https://www.openaip.net/" class="clickable dotted" target="_top">Open AIP</a>`;
			attr(small0, "class", "size-xxs mt-10 svelte-1a6fozg");
