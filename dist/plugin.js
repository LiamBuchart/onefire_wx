const __pluginConfig =  {
  ...
  "built": 1750311736896,
  "builtReadable": "2025-06-19T05:42:16.896Z"
};
...
function add_css(target) {
	append_styles(target, "svelte-1v3o2pt", "p.svelte-1v3o2pt{line-height:1.8}img.svelte-1v3o2pt{display:block;width:70%;margin:0 auto}");
}
...
// (40:4) {#each [ 1, 2, 3, 4, 5, 6, 7, 8, 9 ] as _line  }
function create_each_block(ctx) {
	...
	return {
		c() {
			p0 = element("p");
			p0.textContent = "The major advantage of rhpane and mobile fullscreen layout is ability to display a lot of information in a single view.";
			t1 = space();
			p1 = element("p");
			p1.textContent = "Overflowed content is scrollable and it works like a charm especially on mobile devices.\n        ";
			attr(p0, "class", "svelte-1v3o2pt");
...
function create_fragment(ctx) {
	...
	let mounted;
	let dispose;
	let each_value = ensure_array_like([1, 2, 3, 4, 5, 6, 7, 8, 9]);
	let each_blocks = [];
	...
	return {
		c() {
			...
			t3 = space();
			p0 = element("p");
			p0.textContent = "Add Canadian wildfire perimeters to the map.";
			t5 = space();
			p1 = element("p");
			p1.textContent = "At this time all perimeters > 200 hectares are displayed.";
			t7 = space();
			p2 = element("p");
			p2.textContent = "Visit https://cwfis.cfs.nrcan.gc.ca/home for more information.";
			t9 = space();
			p3 = element("p");
			p3.innerHTML = `<img src="https://www.windy.com/img/windy-plugins/borat-great-success-ed.png" alt="Borat" class="svelte-1v3o2pt"/>`;
			t10 = space();
			div2 = element("div");
			...
			attr(p1, "class", "svelte-1v3o2pt");
			attr(p2, "class", "svelte-1v3o2pt");
			attr(p3, "class", "mt-30 mb-30 svelte-1v3o2pt");
